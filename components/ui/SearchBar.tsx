  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <input
        ...
        className="h-9 w-full pl-9 pr-8 text-sm bg-white dark:bg-[#252836] text-gray-900 dark:text-gray-100 border border-white-border dark:border-gray-600 rounded-lg placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 transition-colors"
